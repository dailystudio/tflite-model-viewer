...
import com.dailystudio.tensorflow.lite.viewer.text.model.ChatRecordViewModel
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

abstract class AbsChatActivity<Results> : AbsTFLiteModelViewerActivity<InferenceInfo, Results>() {
